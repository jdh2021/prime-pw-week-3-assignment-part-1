...
let favoriteFoods = ['chili paneer', 'bean and cheese burrito', 'clam chowder'];
...
console.log('Second amimal is', animalArray[1]);
...
favoriteFoods.push('chicken jalfrezi');
...
favoriteFoods[1] = 'split pea soup';
console.log('The favorite foods are now:', favoriteFoods);
